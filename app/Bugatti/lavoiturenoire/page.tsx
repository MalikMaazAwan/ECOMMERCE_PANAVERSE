...
const ProductPage: React.FC<ProductPageProps> = ({ productId }) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        productId = "5e1e2ba1-dd0a-4adc-8451-9af46328d26c";
        const response: Product | null = await client.fetch(
  ...
  return (
    <div>
      ...
      <div className=" w-screen h-screen   container mx-auto py-10 pl-20 bg-white">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="  pt-[7%]   md:w-1/2 md:pl-8">
