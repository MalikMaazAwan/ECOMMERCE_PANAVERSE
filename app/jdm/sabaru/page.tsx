...
const ProductPage: React.FC<ProductPageProps> = ({ productId }) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        productId = "859d047c-8231-4d4b-a6a5-6cbf2a8cfb2f"
    ...
    <div className=" w-auto h-auto   container mx-auto py-10 pl-20 bg-white">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2">
          <img
            src={`https://cdn.sanity.io/images/6dacafhr/production/d68338c1bcedfb4c20b7fca709a662e083e2d01b-3978x5967.jpg`}
