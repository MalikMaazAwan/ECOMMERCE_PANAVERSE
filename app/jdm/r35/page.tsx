...
const ProductPage: React.FC<ProductPageProps> = ({ productId }) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        productId = "e8ea1386-3940-4dc9-acec-b10d13755d27"
    ...
    <div className=" w-auto h-auto   container mx-auto py-10 pl-20 bg-white">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2">
          <img
            src={`https://cdn.sanity.io/images/6dacafhr/production/1cd4ca9f10cc6c637860c109b4b1769d86b0c50e-3926x4907.jpg`}
