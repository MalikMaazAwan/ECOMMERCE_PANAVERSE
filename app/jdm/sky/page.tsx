...
const ProductPage: React.FC<ProductPageProps> = ({ productId }) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        productId = "60d96693-59cf-47a9-afd2-477fbfdb2d67"
    ...
    <div className=" w-auto h-auto   container mx-auto py-10 pl-20 bg-white">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2">
          <img
            src={`https://cdn.sanity.io/images/6dacafhr/production/9042ead13674d558271267713ae837879cc81c5a-3931x5897.jpg`}
