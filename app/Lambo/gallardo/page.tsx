...
const ProductPage: React.FC<ProductPageProps> = ({ productId }) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        productId = "a4efac8a-06aa-4d5b-a24e-d273ef956433"
    ...
    <div className=" w-auto h-auto   container mx-auto py-10 pl-20 bg-white">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2">
          <img
            src={`https://cdn.sanity.io/images/6dacafhr/production/7028672e169ffe4004936f9323e0498b572a23d4-4228x5285.jpg`}
